...
MODULE_NEIGHBORS = [
    ...
    ("procrastination", "low_self_esteem"),
    ("anger", "relationship_stress"),
    ("anger", "work_stress"),
    ("anger", "gad"),
    ("exam_anxiety", "gad"),
    ("exam_anxiety", "procrastination"),
    ("exam_anxiety", "insomnia"),
    ("exam_anxiety", "low_self_esteem"),
    ("body_image", "low_self_esteem"),
    ("body_image", "social_anxiety"),
    ("body_image", "depression"),
    ("chronic_pain", "depression"),
    ("chronic_pain", "insomnia"),
    ("chronic_pain", "life_transitions"),
    ("chronic_pain", "health_anxiety"),
    ("financial_stress", "gad"),
    ("financial_stress", "depression"),
    ("financial_stress", "insomnia"),
    ("financial_stress", "work_stress"),
    ("financial_stress", "relationship_stress"),
]
